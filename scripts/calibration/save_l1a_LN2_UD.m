function calibrationTool = save_l1a_LN2_UD(calibrationTool,logFile,calibratedSpectra,warningLevel0)
%==========================================================================
...
%           | tests to see each key in the csv file to see if 
%           | it exists in the calibratedSpectra function. If 
...
for i = 1:length(calibratedSpectra)
    calibratedSpectra(i).frequency = calibratedSpectra(i).freq(:,2)';
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:calibrationTool.spectrometerQuantity
   ...
   for k = 1:height(lookUpFields)
       ...
       if isfield(tempStruct, lookUpFields.CS_name{k})
           ...
           ncFieldName = strcat( N_spectro, '/' , lookUpFields.CS_name(k));
