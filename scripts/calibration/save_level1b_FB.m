...
% Some variables specific to FB
nccreate(filename,'/spectrometer1/intermediate_freq_theory','Dimensions',{'channel_idx',calibrationTool.numberOfChannels,'time',Inf},'Datatype','double','FillValue',-9999)
nccreate(filename,'/spectrometer1/channel_width','Dimensions',{'channel_idx',calibrationTool.numberOfChannels,'time',Inf},'Datatype','double','FillValue',-9999)
nccreate(filename,'/spectrometer1/channel_width_theory','Dimensions',{'channel_idx',calibrationTool.numberOfChannels,'time',Inf},'Datatype','double','FillValue',-9999)
...
ncwrite(filename,'/spectrometer1/intermediate_freq_theory',vertcat(integratedSpectra.intermediate_freq_theory)');
ncwrite(filename,'/spectrometer1/channel_width',vertcat(integratedSpectra.channel_width)');
ncwrite(filename,'/spectrometer1/channel_width_theory',vertcat(integratedSpectra.channel_width_theory)');
...
attrVal.if = {'intermediate frequency vector',...
    ...
    'Hz',...
    'intermediate frequency measured by Axel in 2011'};

attrVal.if_theory = {'theoretical intermediate frequency vector',...
    'intermediate_frequency_theory',...
    'Hz',...
    'intermediate frequency assumed before'};

attrVal.channel_width = {'channel width vector',...
    'channel_width',...
    'Hz',...
    'channel width vector measured by Axel in 2011'};

attrVal.channel_width_theory = {'theoretical channel width vector',...
    'channel_width_theory',...
    'Hz',...
    'theoretical channel width vector'};
...
for i=1:length(attrName)
    ...
    ncwriteatt(filename,'/spectrometer1/intermediate_freq_theory',attrName{i},attrVal.if_theory{i});
    ncwriteatt(filename,'/spectrometer1/channel_width',attrName{i},attrVal.channel_width{i});
    ncwriteatt(filename,'/spectrometer1/channel_width_theory',attrName{i},attrVal.channel_width_theory{i});
