...
%         end
        ...
        if isfield(calibrationTool.logFile,'TC')
            ...
            isTC = ([TC.dateTime] >= spectra(t).dateTime  - minutes(calibrationTool.meteoTimeExtension) & [TC.dateTime] < spectra(t).dateTime+minutes(calibrationTool.meteoTimeExtension));
