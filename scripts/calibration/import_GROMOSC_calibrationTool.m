function calibrationTool = import_GROMOSC_calibrationTool(calibrationTool)
%==========================================================================
...
assert(strcmp(calibrationTool.instrumentName, 'GROMOSC'),'Wrong instrument toolbox !')
...
calibrationTool.rawFileFolder=['/mnt/datalake/instrumentdata/gromosc/' calibrationTool.dateStr(1:4) '/'];
...
calibrationTool.filename=['GROMOS-C__', calibrationTool.dateStr];
