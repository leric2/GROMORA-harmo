...
%     end
    ...
    % Specific for FB:
    integratedSpectra(i).channel_width = calibrationTool.channel_width;
    integratedSpectra(i).channel_width_theory = calibrationTool.channel_width_theory;

    integratedSpectra(i).intermediate_freq_theory = calibrationTool.intermediate_freq_theory;
