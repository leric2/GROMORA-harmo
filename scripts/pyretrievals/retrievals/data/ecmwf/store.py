...
class ECMWFLocationFileStore:
    ...
    * The variable holding the level is called `level`
    ...
    def select_time(self, t1, t2, n_levels, **kwargs):
        """
        ...
        if n_levels==91:
            return self.normalize_91(ds)
        elif n_levels==137:
            return self.normalize(ds)
        else:
            print('Please specify ecmwf levels number !')
    ...
    def normalize_91(ds):
        ...
        * Sort by time
        ...
        # Add Pressure
        a = levels.hybrid_level_91['a']
        b = levels.hybrid_level_91['b']
        sp = np.exp(ds['logarithm_of_surface_pressure'])
        ds['pressure'] = a + b * sp
